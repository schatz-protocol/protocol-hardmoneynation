<?php
// This file contains the pseudo-code of the Commercial Loans form.
...
<div>
	<select id="pseudo_input_1" name="pseudo_input_1">
		...
		<option value="Note acquisition">Note acquisition</option>
		<option value="Rehabilitation / construction">Rehabilitation / construction</option>
		<option value="Refinance">Refinance</option>
		<option value="Recapitalization">Recapitalization</option>
		<option value="Discounted note pay-off">Discounted note pay-off</option>
		<option value="Redevelopment / repositioning">Redevelopment / repositioning</option>
		<option value="Lease-up / stabilization">Lease-up / stabilization</option>
		<option value="Partner buy-out">Partner buy-out</option>
		<option value="Bankruptcy / receivership resolution">Bankruptcy / receivership resolution</option>
