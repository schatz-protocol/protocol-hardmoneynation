// We ned to tell multi-step-core what form we're working with.
var form_id = 6;

//////
// Input Validation for Gravity Form #6. (Foreclosure Loan Questions)
//
...
form_validation_array[4] = function() {
	return validatePseudoField(element = 4, '');
};
